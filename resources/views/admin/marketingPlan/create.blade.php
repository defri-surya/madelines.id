...
@section('content')
    ...
    <main>
        ...
        <div class="flex items-center justify-between px-4 py-4 border-b lg:py-6 dark:border-primary-darker">
            <h1 class="text-2xl font-semibold">Tambah Marketing Plan</h1>
        </div>
            ...
            <div class="grid grid-cols-1 p-4 space-y-8 lg:gap-12 lg:space-y-0 lg:grid-cols-12">
                ...
                <div class="col-span-2 bg-white rounded-md dark:bg-darker" x-data="{ isOn: false }">
                    ...
                    <div class="flex items-center justify-between p-4 border-b dark:border-primary">
                        <h4 class="text-lg font-semibold text-gray-500 dark:text-light">Tambah Marketing Plan</h4>
                    </div>
                    <!-- Chart -->
                    <div class="relative p-4">
                        <form method="POST" action="{{ url('marketplan-store?ref=' . request('ref')) }}" class="space-y-6"
