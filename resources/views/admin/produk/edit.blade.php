            ...
            <div class="grid grid-cols-1 p-4 space-y-8 lg:gap-12 lg:space-y-0 lg:grid-cols-12">
                ...
                <div class="col-span-2 bg-white rounded-md dark:bg-darker" x-data="{ isOn: false }">
                    ...
                    <div class="flex items-center justify-between p-4 border-b dark:border-primary">
                        <h4 class="text-lg font-semibold text-gray-500 dark:text-light">Edit Produk</h4>
                    </div>
                    <!-- Chart -->
                    <div class="relative p-4">
                        <form method="POST" action="{{ url('produk-update/' . $produk->id . '/?ref=' . request('ref')) }}"
                            ...
                            <input
                                ...
                                type="text" name="title" placeholder="Nama Produk" value="{{ $produk->title }}"
                                required autofocus />

                            <input
                                class="w-full px-4 py-2 border rounded-md dark:bg-darker dark:border-gray-700 focus:outline-none focus:ring focus:ring-primary-100 dark:focus:ring-primary-darker"
                                type="number" name="harga" placeholder="Harga" value="{{ $produk->harga }}" required
                                autofocus />
